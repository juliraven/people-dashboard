...
with col[0]:
    ...
    with styled_container:
        ...
        with col1:
            st.markdown(
    f"""
    <div style='border: 2px solid #FF69B4; border-radius: 10px; padding: 10px; width: 110px; text-align: center;'>
    ...
    unsafe_allow_html=True
        ...
        with col2:
            st.markdown(
    f"""
    <div style='border: 2px solid #1E90FF; border-radius: 10px; padding: 10px; width: 110px; text-align: center;'>
