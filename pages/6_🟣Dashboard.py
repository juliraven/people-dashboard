...
col = st.columns((1.6, 5, 2.1), gap='medium')
...
with col[2]:
    ...
    with st.container(border=True):
        with st.expander('Żródło danych:', expanded=True):
            st.markdown('<span style="color: purple; font-weight: bold;">World population:</span><a href="https://ourworldindata.org/population-growth" target="_blank">https://ourworldindata.org/population-growth</a>',
